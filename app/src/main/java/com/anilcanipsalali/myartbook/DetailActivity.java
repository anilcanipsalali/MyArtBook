package com.anilcanipsalali.myartbook;
...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        artNameText = findViewById(R.id.artNameEditText);
        artistNameText = findViewById(R.id.artistNameEditText);
        yearText = findViewById(R.id.yearEditText);
        ...
        if(info.matches("new")) {
            ...
            try {
                ...
                while(cursor.moveToNext()) {
                    ...
                    artistNameText.setText(cursor.getString(artistNameIndex));
